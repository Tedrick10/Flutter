...
// Pages
import '../pages/sales_details_page.dart';
...
// SalesTableWidget: StatelessWidget Class
class SalesTableWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String totalQuantity = salesProvider.getAllTotalQuantity;
    final String totalAmount = salesProvider.getAllTotalAmount;
