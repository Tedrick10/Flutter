...
// SalesDetailsTableWidget: StatelessWidget Class
class SalesDetailsTableWidget extends StatelessWidget {
  // Final: Class Properties
  final List<String> tableHeadersList;
  final List<DataModel> tableBodiesList;

  // Constructor
  const SalesDetailsTableWidget({
                                        ...
                                        child: ElevatedButton(
                                          ...
                                          onPressed: () {
                                            if (addFormKey.currentState!
                                                .validate()) {
                                              DataModel dataModel = DataModel(
                                                date: tableBodiesList[0].date,
                                                invoiceNo: tableBodiesList[0]
                                                    .invoiceNo,
                                                stockCode:
                                                    stockCodeController.text,
                                                description:
