...
// Widgets
import '../widgets/purchase_details_table_widget.dart';

// PurchaseDetailsPage: StatelessWidget Class
class PurchaseDetailsPage extends StatelessWidget {
  // Static & Constant: Class Properties
  static const String title = "Purchase Details";
  ...
  Widget build(BuildContext context) {
    ...
    final TotalDataModel totalDataModel =
        purchaseProvider.searchTotalWithInvoiceNo(invoiceNo);
    final List<DataModel> dataList =
        purchaseProvider.searchDataListWithInvoiceNo(invoiceNo);
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: PurchaseDetailsTableWidget(
